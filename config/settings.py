...
class Settings(BaseModel):
    """Comprehensive application configuration management with environment variable support.
    ...
    app_description: str = Field(
        default="A comprehensive FastAPI application with full user management capabilities"
    )
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        Args:
            **kwargs: Additional keyword arguments to override environment/default values
        ...
        env_values = {
            ...
            "app_description": os.getenv("APP_DESCRIPTION", "A comprehensive FastAPI application with full user management capabilities"),
            "app_environment": Environment(os.getenv("APP_ENVIRONMENT", "development")),
            "app_debug": os.getenv("APP_DEBUG", "false").lower() == "true",
            
            # Database
            "database_url": os.getenv("DATABASE_URL", "sqlite+aiosqlite:///./database/users.db"),
            ...
            # Security
            "security_secret_key": os.getenv("SECURITY_SECRET_KEY", "your-super-secret-key-change-this-in-production-min-32-chars"),
            ...
            "security_password_require_uppercase": os.getenv("SECURITY_PASSWORD_REQUIRE_UPPERCASE", "true").lower() == "true",
            "security_password_require_lowercase": os.getenv("SECURITY_PASSWORD_REQUIRE_LOWERCASE", "true").lower() == "true",
            "security_password_require_digits": os.getenv("SECURITY_PASSWORD_REQUIRE_DIGITS", "true").lower() == "true",
            "security_password_require_special": os.getenv("SECURITY_PASSWORD_REQUIRE_SPECIAL", "true").lower() == "true",
            
            # JWT
            "jwt_secret_key": os.getenv("JWT_SECRET_KEY", "your-jwt-secret-key-change-this-in-production-min-32-chars"),
            ...
            "server_access_log": os.getenv("SERVER_ACCESS_LOG", "true").lower() == "true",
            
            # CORS
            "cors_origins": self._parse_list(os.getenv("APP_CORS_ORIGINS", "*")),
            "cors_methods": self._parse_list(os.getenv("APP_CORS_METHODS", "GET,POST,PUT,DELETE,PATCH")),
