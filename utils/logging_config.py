...
def setup_logging(
    ...
    """Configure comprehensive application logging with structured output and observability.
...
def get_logger(name: Optional[str] = None) -> StructuredAdapter:
    """Get a structured logger instance with automatic name detection and context support.
    ...
    Returns:
        StructuredAdapter: Enhanced logger adapter with structured logging capabilities
                          Provides all standard logging methods (info, debug, warning, error, critical) 
                          with automatic context injection and field enrichment
